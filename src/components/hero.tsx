...
export function Hero() {
  ...
  const [ringColor, setRingColor] = useState('ring-accent');
  ...
  return (
    <section id="home" className="relative h-screen w-full flex items-center justify-center -mt-14 pt-14">
      <div className="container flex h-full flex-col items-center justify-center text-center">
        ...
        {userPortrait && (
          <Avatar className={cn("w-32 h-32 md:w-40 md:h-40 mb-8 border-4 border-background ring-4 transition-colors duration-500", ringColor)}>
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <span className="block min-h-[1.2em]">
            <TypedRoles roles={USER_DETAILS.roles} onColorChange={setRingColor} />
          </span>
        </h1>
